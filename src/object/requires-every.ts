 ...
 *
 * Relations
 * - {@link BanKeysEvery} - inverse
 * - {@link RequiresAny} - any
 */
export function RequiresEvery(keys?: SD.Value<Array<string>>): ClassDecorator;
export function RequiresEvery(keys?: SD.Value<Array<string>>): PropertyDecorator;
export function RequiresEvery(keys?: SD.Value<Array<string>>): ParameterDecorator;
export function RequiresEvery(opt?: O): ClassDecorator;
export function RequiresEvery(opt?: O): ParameterDecorator;
export function RequiresEvery(opt?: O): ParameterDecorator;
export function RequiresEvery(v1?: SD.Value<Array<string>> | O): ClassDecorator | PropertyDecorator | ParameterDecorator {
...
const deco = decorator.addIdentifier(RequiresEvery, ['field', 'parameter']);
