...
import {arrayType, SD} from "@leyyo/scalar";
 ...
 *
 */
export function IsArray(weak?: SD.Value<boolean>): PropertyDecorator;
export function IsArray(weak?: SD.Value<boolean>): ParameterDecorator;
export function IsArray(opt?: O): ParameterDecorator;
export function IsArray(opt?: O): ParameterDecorator;
export function IsArray(v1?: SD.Value<boolean> | O): PropertyDecorator | ParameterDecorator {
...
const deco = decorator.addIdentifier(IsArray, ['field', 'parameter']);
