...
import {integerType, SD} from "@leyyo/scalar";
 ...
 *
 */
export function IsInteger(weak?: SD.Value<boolean>): PropertyDecorator;
export function IsInteger(weak?: SD.Value<boolean>): ParameterDecorator;
export function IsInteger(opt?: O): ParameterDecorator;
export function IsInteger(opt?: O): ParameterDecorator;
export function IsInteger(v1?: SD.Value<boolean> | O): PropertyDecorator | ParameterDecorator {
...
const deco = decorator.addIdentifier(IsInteger, ['field', 'parameter']);
