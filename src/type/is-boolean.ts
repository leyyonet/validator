...
import {booleanType, SD} from "@leyyo/scalar";
 ...
 *
 */
export function IsBoolean(weak?: SD.Value<boolean>): PropertyDecorator;
export function IsBoolean(weak?: SD.Value<boolean>): ParameterDecorator;
export function IsBoolean(opt?: O): ParameterDecorator;
export function IsBoolean(opt?: O): ParameterDecorator;
export function IsBoolean(v1?: SD.Value<boolean> | O): PropertyDecorator | ParameterDecorator {
...
const deco = decorator.addIdentifier(IsBoolean, ['field', 'parameter']);
