...
export interface ValidatorRunLike {
    ...
    runForClass(clazz: ClassReflectionLike | Fnc | ClassLike, ctx: Ctx, values: Dict, prevField?: string): Promise<Array<ExceptionLike>>;
    hasMethod(methodRef: PropertyReflectionLike, ignoredIndexes: Array<number>): boolean;
    runForMethod(methodRef: PropertyReflectionLike, ctx: Ctx, values: Array<any>, ignoredIndexes: Array<number>): Promise<Array<any>>;
}
